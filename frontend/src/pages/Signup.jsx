    ...
    <div className="min-h-screen flex items-center justify-center bg-royal-900 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-royal-800 to-royal-900 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 glass-card p-10 rounded-2xl z-10 animate-fade-in relative">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="mt-2 text-sm text-gray-400">Join the royal workspace</p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div>
              <select
                id="role"
                name="role"
                className="appearance-none relative block w-full px-4 py-3 bg-royal-800 border border-white/10 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-royal-gold focus:border-transparent sm:text-sm transition-all duration-300"
                value={role}
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg gold-gradient shadow-[0_0_20px_rgba(212,175,55,0.4)] hover:shadow-[0_0_30px_rgba(212,175,55,0.6)] hover:-translate-y-0.5 transition-all duration-300"
            >
              Create Account
            </button>
          </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-400">
            ...
            <Link to="/login" className="font-medium text-royal-gold hover:text-royal-champagne transition-colors">
              Sign in
            </Link>
          </p>
        </div>
